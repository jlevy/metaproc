...
def _inspect_wheel(wheel: Path) -> None:
    with zipfile.ZipFile(wheel) as archive:
        ...
        required_suffixes = {
            ...
            "metaproc/docs/metaproc-design.md",
            "metaproc/docs/process-framework-concepts.md",
            "metaproc/docs/conventions.md",
            "metaproc/docs/artifact-catalog.md",
            "metaproc/docs/execution-model-design.md",
            "metaproc/docs/credential-setup.runbook.md",
            "metaproc/docs/cloud-dispatch.runbook.md",
            "metaproc/docs/arch-authentication.md",
            "metaproc/docs/arch-cloud-execution.md",
            "metaproc/docs/arch-runpool.md",
            "metaproc/docs/arch-claude-code-harness.md",
            "metaproc/docs/arch-execution-model.md",
            "metaproc/docs/arch-testing.md",
            "metaproc/docs/arch-file-io-utilities.md",
...
def _inspect_sdist(sdist: Path) -> None:
    with tarfile.open(sdist, "r:gz") as archive:
        ...
        required_suffixes = {
            ...
            "src/metaproc/docs/process-framework-concepts.md",
            "src/metaproc/docs/conventions.md",
            "src/metaproc/docs/artifact-catalog.md",
            "src/metaproc/docs/execution-model-design.md",
            "src/metaproc/docs/credential-setup.runbook.md",
            "src/metaproc/docs/cloud-dispatch.runbook.md",
            "src/metaproc/docs/arch-authentication.md",
            "src/metaproc/docs/arch-cloud-execution.md",
            "src/metaproc/docs/arch-runpool.md",
            "src/metaproc/docs/arch-claude-code-harness.md",
            "src/metaproc/docs/arch-execution-model.md",
            "src/metaproc/docs/arch-testing.md",
