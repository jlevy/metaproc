...
class TestIOSpec:
    ...
    def test_contract_accepts_either_spelling(self):
        ...
        canonical = IOSpec(path="out.md", contract="example:Prediction/v1")
        ...
        legacy = IOSpec.model_validate({"path": "out.md", "schema": "example:Prediction/v1"})

        assert canonical.contract == "example:Prediction/v1"
        assert legacy.contract == "example:Prediction/v1"
        assert legacy == canonical

    def test_contract_serializes_under_its_own_name(self):
        spec = IOSpec(path="out.md", contract="example:Prediction/v1")
