...
child_order_hints:
  ...
  - is-01m2h566yhqdxbdjcj74hsrr5p
created_at: 2026-09-10T18:42:53.933Z
updated_at: 2026-09-14T23:50:46.920Z
---
...
PR #82, tracked by child mp-sexd, implements the pooled native-session foundation: complete Codex rollouts and opt-in Claude transcripts survive credential-slot teardown under the isolated `.logs/native/` namespace with private permissions and an explicit operational retention/privacy contract. This does not close the feature. Attempt locators, raw pre-filter stdout/stderr, direct open/tail affordances, all provider and lifecycle states, cloud/hydrated mapping, compression and expiry visibility, and durable availability policy remain open.
