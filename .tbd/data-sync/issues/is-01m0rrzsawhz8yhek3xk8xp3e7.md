...
updated_at: 2026-08-25T16:59:49.018Z
...
Ordinary mapped-scope resume reruns only the failed item while retaining completed siblings. The first slice therefore does not add qualified per-item or child-step force. Existing run-wide force and root skip remain; a narrower selector is deferred until framework-owned operator evidence requires it.
