...
updated_at: 2026-08-26T06:54:39.415Z
---
...
First deliverable is a public Metaproc plan spec and architecture review, with no implementation mixed into PR 49. Evaluate the smallest PlanDocument/0.1 that can serialize existing authored, binding, expansion, and durable run facts without adding scheduler authority. Implementation begins only after the golden matrix, compatibility boundary, and migration from current Plan/PlanBundle/VizModel CLI outputs are reviewed.
