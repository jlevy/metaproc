---
type: is
id: is-01kyh26keebb99grmnv3szck5f
title: Open the standalone migration pull request
kind: task
status: closed
priority: 1
version: 3
...
---
Establish a reviewable main branch for the new repository, update the standalone extraction branch without rewriting the exact extraction commits, open the full migration PR, and watch CI to a terminal result.
